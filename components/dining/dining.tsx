...
export default function HotelDining({
  ...
  return (
    <div className="container px-4 py-20">
      ...
      <h2 className="text-textxl font-bold mb-4 mt-8">
        Where curated cocktails meet world-class cuisine
      </h2>
      <div className="grid md:grid-cols-2 gap-8">
        <p className="text-gray-600">
          Balancing storied architectural features with a contemporary design
          aesthetic, Capella Sydney celebrates the Australian panorama through
          its interiors, location and experiences. The ground-level showcases
          three food and beverage outlets – all top restaurants in sydney and
          within footsteps of the glistening harbour foreshore, the famed Sydney
